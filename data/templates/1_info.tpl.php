...
<li style="<? if(in_array($mymps['title'],array('价格','租金'))) { ?>color:red; font-weight:bold;<?php } ?>"><span><?=$mymps['title']?>：</span><? if(in_array($mymps['value'],array('0元','0元/月','0万元','0元/平米','0元/平米/天','0平米'))) { ?>面议<?php } else { ?><?=$mymps['value']?><?php } ?></li>
<?php } ?>
                        <?php }} ?>
</ul>
</div>
...
<ul><?php if(is_array($relate_cat)){foreach($relate_cat as $mymps) { ?><?php if(is_array($mymps['children'])){foreach($mymps['children'] as $w) { ?><li><a target="_blank" href="<?=$city['domain']?><?=$w['uri']?>" title="<?=$city['cityname']?><?=$w['catname']?>"><?=$w['catname']?></a></li>
<?php }} ?>
                    <?php }} ?>
</ul>
</div>
