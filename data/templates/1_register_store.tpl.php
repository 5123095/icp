...
<td><input type="text" name="mobile" class="input input-large" require="mobile" datatype="mobile" min="1" msg="请输入正确的手机号码"/>
</td>
</tr>
            <tr>
...
<td><input type="text" name="checkcode" datatype="limit|ajax" require="true" class="input input-small" id="checkcode" min="1" msgid="code" msg="请输入验证码" url="<?=$mymps_global['SiteUrl']?>/javascript.php?part=chk_authcode"> <span id="code"></span>
</td>
</tr>
            <tr>
            <td>&nbsp;</td>
